...
WIKI_PAGES = [
    ...
    'Replenishment-Engine', 'SAP-Integration', 'Frontend', 'Infrastructure', 'Watcher', 'Ingest', 'Extract',
]
...
def _system_prompt() -> str:
    return (
        ...
        'Replenishment-Engine, SAP-Integration, Frontend, Infrastructure, Watcher, Ingest, Extract, Index. '
